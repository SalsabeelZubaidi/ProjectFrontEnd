                    ...
                    <View style={styles.planContainer}>
                        <View style={styles.paragraphs}>
                            ...
                            <View style={styles.subPar}>
                                ...
                                <Text style={styles.planNameSub}> {translation('planNameCold')} </Text>
                                <Text style={styles.planReason}> {translation('planReasone')} </Text>
                                <Text style={styles.planReasonSub}> {translation('coldPlanReson')} </Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.paragraphs}>
                            ...
                            <View style={styles.subPar}>
                                <Text style={styles.paragraphsFields}>{translation('week1')}</Text>
                                    <Text style={styles.weekSubs}> {translation('coldWeek1Goal')}</Text>
                                <Text style={styles.paragraphsFields}>{translation('week2')}</Text>
                                    <Text style={styles.weekSubs}> {translation('coldWeek2Goal')}</Text>
                                <Text style={styles.paragraphsFields}>{translation('week3')}</Text>
                                    <Text style={styles.weekSubs}> {translation('coldWeek3Goal')}</Text>
